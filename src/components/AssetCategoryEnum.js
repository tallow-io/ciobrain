...
export const AssetCategoryEnum = {
    APPLICATION: {
        name: "Application", index: "1", color: "var(--red)", backgroundColor: "var(--opaque-red)", icon: appIcon
    },
    DATA: {
        name: "Data", index: "2", color: "var(--green)", backgroundColor: "var(--opaque-green)", icon: dataIcon
    },
    INFRASTRUCTURE: {
        name: "Infrastructure",
        index: "3",
    ...
    TALENT: {
        name: "Talent", index: "4", color: "var(--yellow)", backgroundColor: "var(--opaque-yellow)", icon: talentIcon
    },
    PROJECTS: {
        name: "Projects",
        index: "5",
    ...
    BUSINESS: {
        name: "Business", index: "6", color: "var(--gray)", backgroundColor: "var(--opaque-gray)", icon: businessIcon
    }
}
