...
export default class App extends Component {
    constructor(props) {
        super(props)
        this.state = {
            selectedCategory: null, selectedAssetKey: null, messages: []
        }
        window.app = this
    ...
    selectAsset(selectedCategory, selectedAssetKey) {
        this.setState({
            selectedCategory: selectedCategory, selectedAssetKey: selectedAssetKey, messages: []
        })
    }
    ...
    render() {
        return <div>
            <Header/>
            <AssetDetails selectedCategory={this.state.selectedCategory}
            ...
            {this.state.messages && this.state.messages.map((message, index) => <MessageModal
                key={index} index={index} message={message} removeMessage={this.removeMessage}/>)}
        </div>
    }
}
